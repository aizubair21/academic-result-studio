...
.result-table th, .result-table td { border: 1px solid #334155; padding: 5px 6px; text-align: center; vertical-align: middle; }
.result-table th { background: #e2e8f0; font-weight: 700; }
.result-table small { color: #64748b; font-size: 9px; }
