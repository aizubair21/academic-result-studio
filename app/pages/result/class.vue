...
<template>
  <div class="bg-slate-900 h-screen print:bg-white">
    <div v-if="!loading"
      class="result-controls mx-auto flex max-w-[1100px] gap-3 py-5 print:hidden sticky top-0 left-0 w-full bg-slate-900 z-50">
